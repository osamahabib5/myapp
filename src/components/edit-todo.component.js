...
export default class EditToDo extends Component {
    ...
    //method to get values from backend database
    componentDidMount() {
        axios.get('http://localhost:4000/todos/' +
            this.props.match.param.ids).then(response => {
                this.setState({
                    todo_description: response.data.
                        todo_description,
            ...
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-check">
                        <input type="checkbox" className="form-check-input"
                            id="compltetedCheckBox" name="completedCheckBox"
                            onChange={this.state.toDoCompleted}
                ...
                <div className="form-group">
                    <input type="submit" value="
                        Update Todo" className = "btn btn-primary"/>
                    </div>
                </form>
            </div >
        )
